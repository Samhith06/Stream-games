...
export const SEED_SLOTS: SeedSlot[] = [
  ...
  { name: 'Sweet Bonanza Xmas', provider: PRAGMATIC, aliases: ['sweet xmas', 'bonanza xmas'] },
  { name: 'Sugar Rush Xmas', provider: PRAGMATIC, aliases: ['sugar xmas'] },
  { name: 'Gates of Olympus Super Scatter', provider: PRAGMATIC, aliases: ['gates super', 'goo super'] },
  { name: 'Gates of Hades', provider: PRAGMATIC, aliases: ['goh'] },
  { name: 'Sword of Ares', provider: PRAGMATIC, aliases: ['ares', 'sword'] },
  { name: 'Wisdom of Athena', provider: PRAGMATIC, aliases: ['athena', 'wisdom'] },
  { name: 'Fruit Party 2', provider: PRAGMATIC, aliases: ['fp2'] },
  { name: 'Starlight Christmas', provider: PRAGMATIC, aliases: ['starlight xmas'] },
  { name: 'Big Bass Bonanza Megaways', provider: PRAGMATIC, aliases: ['big bass mw', 'bbmw'] },
  { name: 'Big Bass Halloween', provider: PRAGMATIC, aliases: ['bass halloween'] },
  { name: 'Big Bass Christmas Bash', provider: PRAGMATIC, aliases: ['bass xmas', 'christmas bash'] },
  { name: 'Wild West Gold Megaways', provider: PRAGMATIC, aliases: ['wwg mw', 'wwgmw'] },
  { name: 'Fire Strike 2', provider: PRAGMATIC, aliases: ['firestrike 2', 'fs2'] },
  { name: 'Cash Elevator', provider: PRAGMATIC, aliases: ['elevator'] },
  { name: 'Down the Rails', provider: PRAGMATIC, aliases: ['rails'] },
  { name: 'Spaceman', provider: PRAGMATIC, aliases: ['space man'] },
  { name: 'Zeus vs Hades Gods of War', provider: PRAGMATIC, aliases: ['gods of war'] },
  { name: 'Mustang Gold', provider: PRAGMATIC, aliases: ['mustang'] },
  { name: 'The Hand of Midas', provider: PRAGMATIC, aliases: ['midas'] },
  { name: 'Peak Power', provider: PRAGMATIC, aliases: ['peak'] },
  { name: 'Fruit Party Non Stop', provider: PRAGMATIC, aliases: ['fruit non stop'] },
  { name: 'Cleocatra', provider: PRAGMATIC, aliases: ['cleo catra'] },
  { name: 'Rise of Samurai Megaways', provider: PRAGMATIC, aliases: ['samurai'] },
  { name: 'Bison Bonanza', provider: PRAGMATIC, aliases: ['bison'] },
  { name: 'Coin Strike Hold and Win', provider: PRAGMATIC, aliases: ['coin strike'] },
  ...
  { name: 'Alien Fruits', provider: HACKSAW, aliases: ['alien'] },
  { name: 'Itero', provider: HACKSAW, aliases: [] },
  { name: 'Xmas Drop', provider: HACKSAW, aliases: [] },
  { name: 'Wild Wild Bananas', provider: HACKSAW, aliases: ['bananas', 'wwb'] },
  { name: 'Cash Compass', provider: HACKSAW, aliases: ['compass'] },
  { name: 'Hot Fruits on Ice', provider: HACKSAW, aliases: ['hot fruits'] },
  { name: 'Deadly 5', provider: HACKSAW, aliases: ['deadly five'] },
  { name: 'Wild Bandito', provider: HACKSAW, aliases: ['bandito'] },
  { name: 'RIP City 2', provider: HACKSAW, aliases: ['rip 2', 'ripcity2'] },
  { name: 'Miner Donkey Trouble', provider: HACKSAW, aliases: ['miner donkey', 'donkey'] },
  { name: 'Buccaneer Bay', provider: HACKSAW, aliases: ['buccaneer'] },
  { name: 'The Rave', provider: HACKSAW, aliases: ['rave'] },
  { name: 'Cursed Crypt 2', provider: HACKSAW, aliases: ['crypt 2'] },
  { name: 'Keeper of the Dead', provider: HACKSAW, aliases: ['keeper'] },
  { name: 'Gladiator Legends', provider: HACKSAW, aliases: ['gladiator'] },
  { name: 'Omni Sphere', provider: HACKSAW, aliases: ['omni'] },
  { name: 'Sabotage', provider: HACKSAW, aliases: [] },
  { name: 'Rocket Reels 2', provider: HACKSAW, aliases: ['rocket 2'] },
  ...
  { name: 'Tombstone RIP', provider: NOLIMIT, aliases: ['trip'] },
  ...
  { name: 'Tombstone', provider: NOLIMIT, aliases: ['tombstone 1'] },
  { name: 'Deadwood R.I.P.', provider: NOLIMIT, aliases: ['deadwood rip'] },
  { name: 'The Border', provider: NOLIMIT, aliases: ['border'] },
  { name: 'Kitchen Drama BBQ Frenzy', provider: NOLIMIT, aliases: ['kitchen drama', 'bbq'] },
  { name: 'Bushwhacked', provider: NOLIMIT, aliases: ['bush whacked'] },
  { name: 'Barbarossa', provider: NOLIMIT, aliases: ['barb'] },
  { name: 'Warrior Ways', provider: NOLIMIT, aliases: ['warrior'] },
  { name: 'Pearl Harbor', provider: NOLIMIT, aliases: ['pearl'] },
  { name: 'Outsourced', provider: NOLIMIT, aliases: [] },
  { name: 'Bounty Hunters', provider: NOLIMIT, aliases: ['bounty'] },
  { name: 'True Kult', provider: NOLIMIT, aliases: ['kult'] },
  { name: 'Gaelic Gold', provider: NOLIMIT, aliases: ['gaelic'] },
  { name: 'Owls', provider: NOLIMIT, aliases: [] },
  { name: 'Space Donkey', provider: NOLIMIT, aliases: [] },
  { name: 'Evil Goblins xBomb', provider: NOLIMIT, aliases: ['goblins', 'evil goblins'] },
